...
import javax.swing.*;             // For Swing-based GUI
import java.sql.*;                // For database connectivity

// Signup2 class for the second page of the sign-up form
public class Signup2 extends JFrame implements ActionListener {
    ...
    Signup2(String formno) {
        ...
        // Initialize labels with text and font
        ...
        // Text fields
        t1 = new JTextField(); // PAN Number
        t1.setFont(new Font("Raleway", Font.BOLD, 14));
        
        t2 = new JTextField(); // CNIC Number
        ...
        // Dropdowns (ComboBox) for selection fields
        ...
        // Set positions and add components to the frame
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        // Determine if senior citizen is selected
        String scitizen = "";
        if(r1.isSelected()){ 
            scitizen = "Yes";
        }
        ...
        // Determine if existing account is selected
        String eaccount = "";
        if(r3.isSelected()){ 
            eaccount = "Yes";
        ...
        try {
            if(t2.getText().equals("")){
                // Show error if CNIC field is empty
                JOptionPane.showMessageDialog(null, "Fill all the required fields");
            } else {
                Conn c1 = new Conn(); // Custom database connection class
                String q1 = "insert into signuptwo values('"+formno+"','"+religion+"','"+category+"','"+income+"','"+education+"','"+occupation+"','"+pan+"','"+aadhar+"','"+scitizen+"','"+eaccount+"')";
                c1.s.executeUpdate(q1); // Execute query

                // Open next sign-up page
